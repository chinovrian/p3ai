...
@section('content')
 ...
 <div class="panel-heading"><h4>Laporan</h4></div>
    <div class="row">
		...
		<form method="post" action="{{route('rekapasessordosen.filterdataass')}}">
			...
			<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="pos-rel">
							<select name="nama_asessor" class="form-control">
								<option>--pilih asessor</option>
								@foreach($nm as $asessor)
								<option >{{$asessor->nama_asessor}}</option>
								@endforeach
							</select>
