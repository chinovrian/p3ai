      ...
      <div class="panel panel-default">
          ...
          <div class="col-md-6 col-sm-9 col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
				...
				{!! Form::model($serdos, ['method' => 'patch','route' => ['serdos.updateCek', $serdos->id]]) !!}
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right">Nama Asessor 1</label>
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right">Nama Asessor 2</label>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<div class="pos-rel">
							<input type="checkbox" name="bp_peneltian" value="1"> Bukti Penugasan <br/>
