      ...
      <div class="panel panel-default">
          ...
          <div class="col-md-6 col-sm-9 col-xs-12">
			...
			<!-- PAGE CONTENT BEGINS -->
				...
				{!! Form::open(array('route' => 'kelengkapan.store','method'=>'POST','class'=>'form form-horizontal','files'=>true)) !!}
				...
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right">Nama Dosem</label>
					<div class="col-sm-9">
						<div class="pos-rel">
